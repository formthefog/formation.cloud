    ...
    return (
      <div className="flex items-center">
        <Button
          variant="outline"
          className={clsx(
            `relative overflow-hidden bg-white/50 backdrop-blur-sm border-gray-200/60`,
            className
          )}
          disabled
        >
      ...
      {primaryWallet ? (
        <div className="flex items-center">
          <div className="px-2 py-2">
            <div
              className={`h-8 w-8 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center text-white font-medium text-sm shadow-inner ${textStyle}`}
            >
    ...
    >
      ...
      >
        {primaryWallet ? (
          <>
            <div
              className={`h-7 w-7 rounded-full bg-gradient-to-r from-blue-500 to-indigo-500 flex items-center justify-center text-white font-medium text-sm shadow-inner ${textStyle}`}
            >
              {user?.email?.charAt(0).toUpperCase() || "A"}
            </div>
