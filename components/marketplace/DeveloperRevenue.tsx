        ...
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 mb-6">
              Join Formation's marketplace at launch and position yourself as a
              pioneer in the AI agent economy. Build and monetize your AI agents
              with our revenue-sharing model.
            </p>
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Earn up to 80% on every request
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Be among the first to reach enterprise customers
                  </p>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Deploy with our SDK in minutes
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-center gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600">
                    Be a Founding Developer
                  </div>
                </div>
              </div>
              <p className="text-gray-600">
                Join Formation at launch and help shape the future of AI agents.
                As a founding developer, you'll have the opportunity to
                establish your presence in the marketplace and set the standard
