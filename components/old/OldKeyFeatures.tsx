...
const OldKeyFeaturesSection = ({ tagline, features }) => {
  return (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-row justify-center items-center text-primary gap-6">
                  ...
                  <p className="text-gray-600 leading-relaxed font-inter">
                    Unlock the power of the Autonomous Age with Formation.
                    Deploy cutting-edge agents and AI models to bring your ideas
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-row justify-center items-center text-primary gap-6">
                  ...
                  <p className="text-gray-600 leading-relaxed font-inter">
                    Share your innovations with the world. Register your agents
                    and customized models on Formation’s marketplace and start
                    earning from your creations.
                  </p>
                </div>
              </div>
            </div>
...
export default OldKeyFeaturesSection;
