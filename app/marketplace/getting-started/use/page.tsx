...
import AgentSelectionGrid from "@/components/getting-started/AgentSelectionGrid";
...
export default function DevelopersGettingStarted() {
  ...
  const handleContinueToDeploy = () => {
    setCurrentStep(3);
    if (step3Ref.current) {
      step3Ref.current.scrollIntoView({ block: "start", behavior: "smooth" });
    }
  };
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 md:py-8 lg:py-12">
      ...
      >
        <div className="text-left md:text-center space-y-4 mt-2 md:mt-12 lg:mt-24">
          ...
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl md:mx-auto leading-relaxed">
            Deploy enterprise-grade AI agents in seconds with our simple,
            powerful API. No setup, no configuration - just instant AI
        ...
        <AgentSelectionGrid
          ...
          handleContinueToSettings={handleContinueToSettings}
        ...
        <section
          ref={step2Ref}
          className={`py-4 md:py-6 transition-opacity duration-300 ${currentStep === 2 ? "opacity-100" : "opacity-70"} scroll-mt-36`}
        >
        ...
        >
          ...
          <Button
            variant="outline"
            onClick={handleReset}
            className="w-full self-center max-w-xs m-auto border-red-500 text-red-500 hover:bg-red-500 hover:text-white text-xs"
          >
            Reset
          </Button>
        </section>
