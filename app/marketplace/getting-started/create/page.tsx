...
import { AvatarUpload } from "@/components/getting-started/AvatarUpload";
import ConfigureAgent from "@/components/getting-started/ConfigureAgent";
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8 py-4 md:py-8 lg:py-12">
      ...
      >
        ...
        />
        <ConfigureAgent agent={agent} setAgent={setAgent} />
